...
sudo apt install make gcc gcc-multilib binutils grub-common xorriso qemu-system-x86 build-essential nasm gcc binutils qemu-system-x86 xorriso grub-pc-bin mtools g++-multilib libgtk-3-dev libgtk-3-0 flex bison build-essential libelf-dev libelf1 libssl-dev
